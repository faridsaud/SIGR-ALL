...
@NamedQueries({
	...
	@NamedQuery(name="Reactivo.findByTipoByUsuarioAndByEstado", query="SELECT r FROM Reactivo r WHERE r.reactivoEstado=:estadoReactivo AND r.usuario.usuarioId=:idUsuario AND r.reactivoTipo=:tipoReactivo")
